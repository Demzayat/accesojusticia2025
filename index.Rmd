...
- <mark style="background-color: #FFEA00; color: black;">CSJN, Fallo "Ramírez Balbuena" [aca](https://drive.google.com/file/d/1Ywkky3GM7QkgfrJzKadus-wxZKdKI1aj/view?usp=sharing) (agregado recién)</mark> 

- <mark style="background-color: #FFEA00; color: black;">DNU 366/2025 [aca](https://servicios.infoleg.gob.ar/infolegInternet/anexos/410000-414999/413297/norma.htm) (agregado recién)</mark>
...
### `r advdate(martes, 6)`. Unidad 3. La práctica - Mujeres
...
- Caso Diaca Sacayan [aca](https://consejomagistratura.gov.ar/wp-content/uploads/2022/04/Camara-nacional-de-Casacion-Crim-y-Correc.-CABA.pdf), [noticia]( https://agenciapresentes.org/2025/04/04/la-corte-desestimo-el-recurso-por-el-travesticidio-de-diana-sacayan-que-implica) y [video](https://www.youtube.com/watch?v=c50-8xF2E5A) a partir de la 1:45 hora
...
### `r advdate(viernes, 6)`. Unidad 3. La práctica - Afro
...
### `r advdate(viernes, 7)` y `r advdate(martes, 8)` . Unidad 4. Litigio Constitucional
...
### `r advdate(viernes, 8)`. Examen final presencial
